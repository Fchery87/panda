module.exports = [
"[project]/apps/web/lib/agent/spec/drift-detection.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        hooks: {
            'tool.execute.after': async (ctx, data)=>{
                ...
                for (const [specId, spec] of state.activeSpecs){
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$lib$2f$agent$2f$harness$2f$plugins$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["plugins"].executeHooks('spec.drift.detected', ctx, driftReport);
                }
                return data;
            }
        }
...
//# sourceMappingURL=apps_web_lib_agent_spec_drift-detection_ts_ace35b0d._.js.map