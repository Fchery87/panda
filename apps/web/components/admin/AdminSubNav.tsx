        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex w-full items-center gap-2 border px-3 py-2 text-left font-mono text-sm transition-colors',
                isActive
...
export function AdminPageHeader({ icon: Icon, title, description, action }: AdminPageHeaderProps) {
  return (
    <div className="mb-8 border-b border-border bg-card p-5 sm:p-6">
