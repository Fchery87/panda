...
export function DiffViewer({
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-full w-full bg-background border border-border rounded-md overflow-hidden",
        className
      )}
    >
      {/* Header */}
...
function DiffLineRow({
  ...
  return (
    ...
    >
      {/* Line Number */}
      <div className="w-12 flex-shrink-0 text-right pr-3 py-0.5 text-muted-foreground/60 select-none bg-muted/30 border-r border-border">
        {lineNumber ?? ""}
      </div>
