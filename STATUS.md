...
- ✅ Phase 4.1: Chat UI components (ChatContainer, MessageList, MessageBubble,
  ChatInput)

**Next task:** Task 4.2 - Implement streaming chat with Vercel AI SDK and Convex
HTTP actions
...
5. `apps/web/app/api/chat/route.ts` - Next.js API route (alternative to Convex
   HTTP)

**Note:** This task requires understanding of both Convex HTTP actions and
